<template>
    <h1 class="title container mt-4 text-center font-bold mb-4 text-4xl"> Our <span class="my-custom-color">Team</span>?</h1>
    <div class="team">
      <div class="member" v-for="(member, index) in team" :key="index">
        ...
        <div class="member-info">
          ...
          <div class="social-links">
            <a v-if="member.hackerrank_link" :href="member.hackerrank_link" target="_blank" class="social-link">
            ...
            <a v-if="member.github_link" :href="member.github_link" target="_blank" class="social-link">
            ...
            <a v-if="member.portfolio_link" :href="member.portfolio_link" target="_blank" class="social-link">
      ...
      return {
        team: [
            { 
                ...
                hackerrank_link: 'https://www.hackerrank.com', 
