<template>
  ...
  <div class="row">
            ...
            <a href="?uri=category/getCategories" class="d-flex gap-3 align-items-center">
            ...
            <a href="?uri=tag/getTags" class="d-flex gap-3 align-items-center"> 
